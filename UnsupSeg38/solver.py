...
from UnsupSeg38.dataloader import (LibriSpeechDataset, MixedDataset, TrainTestDataset,
                        TrainValTestDataset, collate_fn_padd, spectral_size)
from UnsupSeg38.next_frame_classifier import NextFrameClassifier
from UnsupSeg38.utils import (PrecisionRecallMetric, StatsMeter,
...
class Solver(LightningModule):
    def __init__(self, hparams):
        ...
        wandb.login(key='e6fd4e6c17774ac3a2e5437c9a656241f8cd311d')
